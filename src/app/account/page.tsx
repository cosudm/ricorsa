        ...
        <section className="section" style={{ borderTop: 0, paddingTop: 40 }}>
          ...
          <div className="cards">
            <div className="card">
              ...
              {ended && <div className="notice" style={{ marginBottom: 12 }}>Your {user.subscriptionStatus === 'TRIAL_ENDED' ? 'trial' : 'license'} has ended, so the account is on the Free plan. Choose a plan on the pricing page to keep going.</div>}
