...
const CURATED: Record<Cat, Idea[]> = {
  'For you': [
    ...
    { kind: 'Tool', title: 'A writing desk that keeps your voice', what: 'Your style and expertise as standing rules, drafts written with live model help, a library of finished pieces, and exports in the formats you send.', builds: ['style', 'expertise'], prompt: 'Build a writing desk that drafts in my voice from the style and expertise in my graph, keeps a library of pieces, and exports Markdown and HTML.', preview: { layout: 'editor', name: 'Desk', nav: ['Drafts', 'Voice', 'Library'], items: ['Cover note, 210 words', 'Proposal intro', 'Voice: short, numbers first', 'Reading time 1 min'], cta: 'Draft' } },
  ...
  'Tools': [
    { kind: 'Tool', title: 'A writing desk that keeps your voice', what: 'Standing style rules, drafts with live model help, a library of finished pieces, word counts and exports.', builds: ['style', 'expertise'], prompt: 'Build a writing desk that drafts in my voice, keeps a library of pieces, and exports Markdown and HTML.', preview: { layout: 'editor', name: 'Desk', nav: ['Drafts', 'Voice', 'Library'], items: ['Cover note, 210 words', 'Proposal intro', 'Voice: short, numbers first'], cta: 'Draft' } },
    { kind: 'Tool', title: 'An onboarding kit for people who work with you', what: 'The glossary of your world, who is who, how you like things done, and a handbook that exports as one document.', builds: ['entities', 'topics', 'style'], prompt: 'Create an onboarding kit from my graph: glossary, who is who, working preferences, and a handbook export.', preview: { layout: 'table', name: 'Onboarding', nav: ['Glossary', 'People', 'Handbook'], items: ['Core topic, defined', 'A tool you use', 'A company', 'How to brief you'], cta: 'Export' } },
