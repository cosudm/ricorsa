...
export default async function Terms() {
  ...
  return (<><SiteNav signedIn={!!v} /><main className="wrap prose">
    ...
    <h2>Plans and billing</h2><p>Paid plans are billed monthly through PayPal and renew automatically until canceled. Usage limits per plan are shown on the pricing page and may change with notice. Cancel any time from your Account page; access continues until the end of the paid period where PayPal reports it that way.</p>
