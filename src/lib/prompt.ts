...
const FOCUS_TEXT: Record<string, string> = {
  ...
  technical: 'Focus: Technical. The person wants engineering-grade detail: specifications, standards and their clause numbers, parameters with units and tolerances, procedures step by step, failure modes and trade-offs. Prefer standards bodies, manufacturer documentation, datasheets, technical reports and primary engineering sources among the results, name the version or revision a figure applies to, and state assumptions plainly.',
  legal: 'Focus: Legal. Brief the person the way a careful lawyer briefs a colleague: identify the governing law and jurisdiction, cite the statute, regulation, rule or case by name and section, distinguish holding from dicta and binding from persuasive authority, note effective dates and pending changes, and flag where different facts would change the analysis. Prefer primary sources (statutes, regulations, court opinions, agency guidance) among the results. Where the question asks what to do in a specific situation, say once and briefly that this is information, not legal advice, and that a licensed attorney in the jurisdiction should confirm it.',
